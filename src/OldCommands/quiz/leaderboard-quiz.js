...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const array = userdata.sort((a, b) => ((a.Corrects < b.Corrects) ? 1 : -1)).slice(0, 10);
    const forfind = userdata.sort((a, b) => ((a.Corrects < b.Corrects) ? 1 : -1));
    ...
    const ranked = forfind.findIndex(userTried) + 1;
    let txt;
    if (ranked === 1) {
      txt = '1er';
    } else {
