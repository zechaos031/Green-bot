...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const prefixget = await guild.findOne({ serverID: message.guild.id, reason: 'prefix' });
    ...
    const levelActive = await guild.findOne({ serverID: message.guild.id, reason: 'level' });
